        ...
        <section class="error_area">
            <div class="container">
                <div class="error_inner_content">
                    ...
                    <h2>404</h2>
                    <p>Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Donec ullamcorper nulla non metus auctor fringilla integer velit aliquet.</p>
                    <a class="p_btn" href="#">back to home page</a>
                    <a class="quote_btn" href="#">connect to support</a>
                </div>
            </div>
        </section>
